...
public class Processing extends PApplet {
	...
	public Processing() {
		...
		verticalPaths.add(new Path(2, 1));
		verticalPaths.add(new Path(2, 1));
		verticalPaths.add(new Path(3, 4));
		verticalPaths.add(new Path(0, 1));
		verticalPaths.add(new Path(0, 1));
		verticalPaths.add(new Path(5, 2));
		//verticalPaths.add(new Path(4, 5));
		verticalPaths.add(new Path(2, 5));
		verticalPaths.add(new Path(1, 5));
		verticalPaths.add(new Path(0, 5));
		verticalPaths.add(new Path(0, 4));
		verticalPaths.add(new Path(0, 3));
		verticalPaths.add(new Path(1, 3));
		verticalPaths.add(new Path(3, 3));
		verticalPaths.add(new Path(4, 5));
		
		verticalPaths.add(new Path(2, 3));
		verticalPaths.add(new Path(5, 3));
		horizontalPaths.add(new Path(1, 1));
		horizontalPaths.add(new Path(2, 1));
		horizontalPaths.add(new Path(3, 1));
		horizontalPaths.add(new Path(4, 1));
		horizontalPaths.add(new Path(1, 1));
		horizontalPaths.add(new Path(2, 0));
		horizontalPaths.add(new Path(3, 0));
		horizontalPaths.add(new Path(4, 0));
		horizontalPaths.add(new Path(5, 0));
		horizontalPaths.add(new Path(4, 2));
		//horizontalPaths.add(new Path(5, 2));
		horizontalPaths.add(new Path(5, 1));
		horizontalPaths.add(new Path(3, 3));
		horizontalPaths.add(new Path(3, 4));
		horizontalPaths.add(new Path(4, 4));
		horizontalPaths.add(new Path(4, 5));
		horizontalPaths.add(new Path(5, 5));
		horizontalPaths.add(new Path(1, 5));
		horizontalPaths.add(new Path(5, 4));
		horizontalPaths.add(new Path(5, 3));
		horizontalPaths.add(new Path(3, 4));
		horizontalPaths.add(new Path(4, 3));
		horizontalPaths.add(new Path(1, 3));
	...
	public void setup() {
		...
		zone = new EndZone(SCREEN_SIZE - PIPE_LENGTH / 2, SCREEN_SIZE- PIPE_LENGTH / 2, PIPE_LENGTH / 4, box2d);
